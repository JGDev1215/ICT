...
ok(priceServer.includes('"RTY": "RTY=F"'), 'local helper RTY alias missing');
ok(priceServer.includes('"source": "yfinance"'), 'local helper source response missing');
...
ok(JSON.parse(vercelConfig).functions['api/price.py'].runtime === 'python3.12', 'vercel runtime invalid');
