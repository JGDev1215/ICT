...
Decision pass for `docs/qa/docs-implementation-checklist-2026-07-08.md`.
...
| Prompt-pack manual QA reference | Implemented compatibility pointer | Old docs stop pointing to a missing file. | Low. No runtime impact. | `docs/archive/superseded-design/ui-redesign/06-manual-qa-checklist.md` |
