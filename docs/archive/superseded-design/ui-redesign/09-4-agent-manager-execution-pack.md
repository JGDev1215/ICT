...
- `README.md`
- `CHANGELOG.md`
- `docs/archive/superseded-design/ui-redesign/00-tech-decision.md`
...
- `docs/archive/superseded-design/ui-redesign/09-4-agent-manager-execution-pack.md`
- `tests/smoke.js`
...
Now follow your assigned role instructions from `docs/archive/superseded-design/ui-redesign/09-4-agent-manager-execution-pack.md`.
```
