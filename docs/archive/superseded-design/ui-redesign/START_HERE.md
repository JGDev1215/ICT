...
1. docs/archive/superseded-design/ui-redesign/README.md
2. docs/archive/superseded-design/ui-redesign/01-implementation-plan.md
3. docs/archive/superseded-design/ui-redesign/02-design-system-spec.md
4. docs/archive/superseded-design/ui-redesign/03-screen-specs.md
5. docs/archive/superseded-design/ui-redesign/04-agent-workstreams.md
6. docs/archive/superseded-design/ui-redesign/05-agent-prompt-pack.md
7. docs/archive/superseded-design/ui-redesign/06-build-plan-gap-review.md
8. docs/archive/superseded-design/ui-redesign/07-3-agent-codex-guide.md
9. docs/archive/superseded-design/ui-redesign/START_HERE.md
...
- Do not add a build system unless docs/archive/superseded-design/ui-redesign/00-tech-decision.md explicitly approves it.
