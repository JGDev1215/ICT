...
docs/archive/superseded-design/ui-redesign/05-agent-prompt-pack.md
docs/archive/superseded-design/ui-redesign/06-build-plan-gap-review.md
```
...
- docs/archive/superseded-design/ui-redesign/05-agent-prompt-pack.md
- docs/archive/superseded-design/ui-redesign/06-build-plan-gap-review.md
- docs/archive/superseded-design/ui-redesign/07-3-agent-codex-guide.md
...
4. Add a component preview/gallery file, for example:
   ...
   - `docs/archive/superseded-design/ui-redesign/component-gallery.html`
...
Read all docs in `docs/archive/superseded-design/ui-redesign` and inspect the implemented app.
