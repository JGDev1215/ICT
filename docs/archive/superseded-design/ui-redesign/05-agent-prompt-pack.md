...
> Current-status note — 2026-07-08: this prompt pack is historical. References to visible validation/invalidation UI are superseded by the v0.8 workflow; use `docs/archive/superseded-design/ui-redesign/08-qa-release-checklist.md` or `docs/archive/superseded-design/ui-redesign/06-manual-qa-checklist.md` for current QA references.
...
You must follow:
- docs/archive/superseded-design/ui-redesign/README.md
- docs/archive/superseded-design/ui-redesign/01-implementation-plan.md
- docs/archive/superseded-design/ui-redesign/02-design-system-spec.md
- docs/archive/superseded-design/ui-redesign/03-screen-specs.md
- docs/archive/superseded-design/ui-redesign/04-agent-workstreams.md
...
Your job:
1. Read docs/archive/superseded-design/ui-redesign/*.
...
Read:
- docs/archive/superseded-design/ui-redesign/03-screen-specs.md sections 2 and 3
- docs/archive/superseded-design/ui-redesign/04-agent-workstreams.md Workstream 4
...
Read:
- docs/archive/superseded-design/ui-redesign/03-screen-specs.md sections 3 and 4
- docs/archive/superseded-design/ui-redesign/04-agent-workstreams.md Workstream 5
...
Read:
- docs/archive/superseded-design/ui-redesign/03-screen-specs.md sections 5 to 9
- docs/archive/superseded-design/ui-redesign/04-agent-workstreams.md Workstream 6
...
Read all docs/archive/superseded-design/ui-redesign files and inspect the completed code.
...
2. Add docs/archive/superseded-design/ui-redesign/06-manual-qa-checklist.md.
