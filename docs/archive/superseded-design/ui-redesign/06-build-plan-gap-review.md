...
- Add `docs/archive/superseded-design/ui-redesign/00-tech-decision.md` before coding starts.
- Record one of:
...
- Add `design-system.html` or `docs/archive/superseded-design/ui-redesign/component-gallery.html`.
- It should render:
  - buttons
  - chips
  - badges
